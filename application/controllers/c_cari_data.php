...
$cari=$this->input->get('cari');
$this->load->model('m_cari_data');
$beda['cari']=$this->m_cari_data->cariRevisi($cari);
$this->load->view('mahasiswa/v_form_revisi',$beda);
}
function cariUser2(){
$cari=$this->input->get('cari');
$this->load->model('m_cari_data');
...
$beda['cari1']=$this->m_cari_data->cariMahasiswa1($cari);
$beda['cari2']=$this->m_cari_data->cariProposal1($cari);
