...
class C_user_mhs extends CI_Controller {
	...
	function index_(){
        $this->load->view('mahasiswa/index_');
    }
	...
	function revisi(){
        $this->load->view('mahasiswa/v_carirevisi');
    }
	function indexrevisi(){
        $this->load->view('mahasiswa/index_revisi');
    }
	function indexproposal1(){
        $this->load->view('mahasiswa/index_proposal1');
    }
	function indexproposal2(){
        $this->load->view('mahasiswa/index_proposal2');
    }
	...
	$this->load->model('mupload');
        $data['hasil'] = $this->mupload->bacadata();
        $this->load->view('mahasiswa/v_proposal1',$data);
    }
	function proposal2(){
	$this->load->model('mupload');
        $data['hasil'] = $this->mupload->bacadata();
        $this->load->view('mahasiswa/v_proposal2',$data);
    }
   function tampil3(){
...
$this->load->view('mahasiswa/v_pembimbing',$beda);
}
	function tampil21(){
	...
	public function cek_proposal1($npm) { 
	
	 $this->load->model('m_user_mhs');
       
		$data['hasil1'] = $this->m_user_mhs->filterdata2($npm);
        $this->load->view('mahasiswa/upload_ditolak',$data);
    }
	public function cek_proposal2($npm) { 
	 $this->load->model('m_user_mhs');
		$data['hasil1'] = $this->m_user_mhs->filterdata2($npm);
        $this->load->view('mahasiswa/upload_revisi',$data);
    }
	
	public function upload_ditolak($npm) { 
