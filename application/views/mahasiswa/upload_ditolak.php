...
<tr>
          ...
          <td>
            <div class="col-sm-15"><textarea class="form-control" maxlength="100" class="textarea-none-resize" name="judul"><?php echo $hasil1->judul; ?></textarea>
            </div>
            </td>
         </tr>
            <div class="col-sm-10">
         ...
         <tr>
          ...
          <td>
            <div class="col-sm-20">
              <input disabled type="text" name="tgl_proposal" value="<?php echo  date("d/m/Y");?>" class="form-control">
            ...
            <div class="col-sm-20">
                <p>
                  <select class="form-control" name="textket" style="width:120px;" required="true">
                    <option value="proposal1" disabled>proposal1</option>
