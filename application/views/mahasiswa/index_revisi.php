...
<a href="#" class="easyui-linkbutton" iconCls="icon-user" plain="true" onClick="addTab('Cek Pembimbing','tampil5')">Cek Pembimbing</a><br />
<a href="#" class="easyui-linkbutton" iconCls="icon-user" plain="true" onClick="addTab('Info Revisi','revisi')">Info Revisi</a><br  />
