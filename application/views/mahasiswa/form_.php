...
<h3 align="center">Selamat datang  <?php echo $this->session->userdata('status_proposal'); ?>    <b>Mahasiswa</b></h3>
</div>
...
<div id="container">
  ...
  <div id="menu">
  	<span id="icon"><a href="<?php echo site_url('mahasiswa/c_user_mhs/index_'); ?>">
