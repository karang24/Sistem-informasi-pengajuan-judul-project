...
<body>
    <h3><div class="info"  style="margin-bottom:10px">
		...
		<div>Klik tombol pada datagrid toolbar untuk melakukan
	</h3>
 <?php
        ...
        <tr>
            ...
            <td><a align="center">&nbsp;<a class="easyui-linkbutton" iconCls="icon-edit" href="updatedata2/<?php echo $data->nik;?>">
                Update</a> &nbsp;&nbsp;|
                  ...
                  &nbsp;&nbsp;<a onclick="return confirm('Apakah anda yakin akan menghapus data ini ?')" class="easyui-linkbutton" iconCls="icon-remove" href="deletedata2/<?php echo $data->nik;?>">
                Delete</a>
            </td>
        </tr>
        <?php
