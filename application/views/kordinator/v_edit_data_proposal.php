  ...
  <div  align="justify" class="panel-body">
	...
	<table class="table table-striped" align="center">
        ...
        <thead>
          ...
          <tr>
                <th field="d_upload" >Tanggal_upload</th> <td><input name="D_proposal" value="<?php echo $hasil->D_proposal;?>"  readonly size="25" type="hidden"><input disabled type="text" name="D_proposal" value="<?php echo  date("Y/m/d");?>" class="form-control"></td>
            </tr>
            <tr>
          ...
          <option value="<?php echo $data1->nik;?>"><?php echo $no++;?>. <?php echo $data1->nama;?></option>
		  <?php }?>
        </select></div></td></tr>
        <tr>
          ...
          <option value="<?php echo $data2->status;?>"><?php echo $no++;?>. <?php echo $data2->status;?></option>
        <?php }?>
        </select></div></td></tr>
