...
public function cariProposal1($cari)
{
$cari=$this->db->query("select * from proposal where npm LIKE '%$cari%'  ");
return $cari->result();
}
public function cariRevisi($cari)
{
$cari=$this->db->query("select * from bab_1 where npm LIKE '%$cari%'  ");
return $cari->result();
}
...
public function cariMahasiswa1($cari)
{
$cari=$this->db->query("select * from mahasiswa where npm like '%$cari%'  ");
return $cari->result();
}
